    ...
    <div className="box row" id="container-box">
      ...
      >
        ...
        <div className="description nav-color">
          <p>
            Creative Full Stack Developer skilled in designing, developing and maintaining responsive websites in the recruiting
industry. Specialized in ReactJS, Spring and responsive design. Very passionate about aesthetics and UI designs.
          </p>
        </div>
